...
class DatatypesControllerTest < ActionController::TestCase
  ...
  test 'should create datatype' do
    ...
    assert_difference('Datatype.count') do
      post :create, params: { datatype: { identifier: 'datatype_abc123', description: 'ABC123', vocabulary_id: vocabulary.id } }
    end
  ...
  test 'should update datatype' do
    patch :update, params: { id: @datatype.id, datatype: { description: 'updated description' } }
