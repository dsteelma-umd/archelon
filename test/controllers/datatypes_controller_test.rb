...
class DatatypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datatype" do
    assert_difference('Datatype.count') do
      post datatypes_url, params: { datatype: { description: @datatype.description, identifier: @datatype.identifier, vocabulary_id: @datatype.vocabulary_id } }
    end
  ...
  test "should update datatype" do
    patch datatype_url(@datatype), params: { datatype: { description: @datatype.description, identifier: @datatype.identifier, vocabulary_id: @datatype.vocabulary_id } }
