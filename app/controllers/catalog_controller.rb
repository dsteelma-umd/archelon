...
class CatalogController < ApplicationController # rubocop:disable Metrics/ClassLength
  ...
  configure_blacklight do |config| # rubocop:disable Metrics/BlockLength
    ...
    config.add_show_field 'page__member_of__uri', label: 'Member Of', container_title_accessor: 'display_titles', component: ArchelonContainerLinkComponent
    ...
    config.add_show_field 'file__file_of__uri', label: 'File Of', container_title_field: 'page__title__txt', component: ArchelonContainerLinkComponent
